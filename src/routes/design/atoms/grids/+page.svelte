...
<div class="w-full items-center">
    ...
    <div class="m-3">
        <Grid>
            ...
            <GridItem size={{ xs: 6, md: 4, lg: 1 }}>{@render item('xs=6 md=4 lg=1')}</GridItem>
            <GridItem size={{ xs: 6, md: 8, lg: 2 }}>{@render item('xs=6 md=8 lg=3')}</GridItem>
        </Grid>
    </div>

    <div class="inline-block">Responsive columns xs=1 md=2 lg=3</div>
    <div class="m-3">
    ...
    <div class="inline-block">Spacing xs=(1,4) md=(2,4) lg=(4,8)</div>
    <div class="m-3">
